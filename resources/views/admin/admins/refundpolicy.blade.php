    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="col-md-12">
                ...
                ?>
                <form action="{{route('admin.refund-policy.update',[$aContentRefund['id']])}}" method="post">
                ...
                <div class="table-responsive">
                    <div class="form-group inputwrap">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="content_title" id="content_title" class="cat-name form-control required" aria-required="true" value="{{ $aContentRefund['content_title'] }}">
                        </div>
                    </div>
