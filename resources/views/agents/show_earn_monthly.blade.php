    ...
    <script>
        $(document).ready(function(){
            $('.earningYear').on('change',function(){
                ...
                window.location = "{{ action('Users\SalesAgentController@getShowEarningsMonthly',[$id]) }}"+"/"+val+"/"+month;
            });
            $('.earningMonth').on('change',function(){
                var val = $(this).val();
                var year = $('.earningYear').val();
                window.location = "{{ action('Users\SalesAgentController@getShowEarningsMonthly',[$id]) }}"+"/"+year+"/"+val;
            });
        });
    </script>
@endsection