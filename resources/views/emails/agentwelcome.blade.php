            ...
            <td valign="top" align="center">
                ...
                <td valign="top" style="background-color:#fdfdfd">
                    ...
                    <td valign="top" style="padding:48px">
                        ...
                        <p style="margin:0 0 16px">Hello Agent {{ $firstname }} {{ $lastname }}</p>
                        <p style="margin:0 0 16px; text-align:justify;">
                        &emsp;&emsp;&emsp;Thank you for registering to be an agent with TribalSquare.com. We take pride in providing Africans with a one stop website for everything uniquely African.
                        </p>
                        <p style="margin:0 0 16px; text-align:justify;">
                        ...
                        <p>Your help will be invaluable in realizing this objective, and we look forward to a fruitful business relationship with you.</p>
