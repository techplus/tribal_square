		...
		<div class="row user-menu-container square">
	            ...
	            <div class="row coralbg white">
	                <div class="col-sm-6 no-pad">
	                    <div class="user-image">
	                        <img src="{{ url('profile_pictures/'.$oBabySitter->profile_pic) }}" class="img-responsive thumbnail">
	                    </div>
	                </div>
	                <div class="col-sm-6 no-pad">
	                    <div class="user-pad">
	                        <h3>{{ ucFirst($oBabySitter->firstname)." ".ucFirst($oBabySitter->lastname)}}</h3>
	                        <h5 class="white"><i class="glyphicon glyphicon-heart"></i> Age : {{ $oBabySitter->age }}</h5>
	                        <h5 class="white"><i class="glyphicon glyphicon-map-marker"></i> Less than {{ $oBabySitter->miles_from_home }} mile <small style="color: #fff;"> (Atlanta, GA) </small></h5>
	        ...
	        <div class="col-sm-4 user-menu user-pad">
	            <div class="user-menu-content active">
	                ...
	                <p>{{ (strlen($oBabySitter->experience) > 175 ) ? substr($oBabySitter->experience,0,174)."..." : $oBabySitter->experience }}</p>
	                <a href="#" class="btn btn-md custome_blue_btn view_profile_btn">See Full Profile</a>
	            </div>
	        </div>
	    </div>						    
	@endforeach
